...
jQuery.fn.selectToUISlider = function(settings) {
    ...
    if (selects.attr('isCreated') == 'true') return;
    ...
    var subscriber = options.monthYearSubscriber;
    ...
    var sliderOptions = {
        ...
        slide: function(e, ui) {//slide function
            ...
            if (subscriber) subscriber.val(currSelect.val());
        },
        values: (function() {
            var values = [];
            selects.each(function() {
    ...
    selects.bind('change keyup click', function() {
        ...
        if (subscriber) subscriber.val(jQuery(this).val());
    });
    ...
    //inject and return 
    sliderComponent
	.insertAfter(jQuery(this).next().eq(this.length - 1))
    ...
    if (subscriber) selects.val(subscriber.val());
    selects.attr('isCreated', 'true');
    return this;
}
