/*
//TODO we need to change this combobox to add a custom array of objects to display.
jquery.combobox
    ...
    return this.each(
		function() {
		    ...
		    function buildValueDisplay() {
		        ...
		        _valueDisplayJQuery.hover(function() {
		            _valueDisplayJQuery.addClass("Over");
		        }, function() {
		            _valueDisplayJQuery.removeClass("Over");
		        });
		    ...
		    function applyLayout() {
		        ...
		        //TODO: Check why this calculation is wrong when the container is inside an element absolute positioned it fails
		    ...
		    function buildContainer() {
		        ...
		        if (typeof settings.onCreated == 'function') {
		            settings.onCreated(_originalElementJQuery);
		        }
