...
<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="Header.ascx.cs" Inherits="SEOToolSet.WebApp.Header" %>
...
<%--<uc3:IncludeFile ID="IncludeFile1" FilePath="~/scripts/plugins/combobox.css" runat="server"
    TypeOfFile="CSS" />
<uc3:IncludeFile ID="IncludeFile2" FilePath="~/scripts/plugins/jquery.combobox.js"
    runat="server" TypeOfFile="Javascript" />--%>
...
<div class="Header">
    ...
    <div class="QuickLinks">
        <cc1:RoundPanel ID="RoundPanel1" runat="server" NotRenderStyles="true" CssIdClassName="round_ctr ublock">
            <ul class="MainPanel">
                <li>
                    ...
                    <asp:LoginView ID="LoginView2" runat="server">
                        <LoggedInTemplate>
                            <a href="AccountProfile.aspx">
                                <asp:Label ID="userAccount" runat="server" Text="<%$ Resources:CommonTerms, Account %>"></asp:Label></a>
                        </LoggedInTemplate>
                    </asp:LoginView>
                </li>
    ...
    <div class="DomainSelectionTool">
        <div style="float:left; width:50px; color: #1b6ecc; font-weight:bold;">
