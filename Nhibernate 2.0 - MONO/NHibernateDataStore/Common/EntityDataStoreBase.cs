...
namespace NHibernateDataStore.Common
{
    ...
    public abstract class EntityDataStoreBase<T, TId> : IDao<T, TId>
    {
        ...
        protected EntityDataStoreBase(ITransactionScope transactionScope)
        {
        ...
        {
            TransactionScope = new TransactionScope(session, session.Transaction, false);
        }

        /// <summary>
        /// Construct an instance of EntityDataStoreBase using a session retrieved from the Current Handler
        /// </summary>
        protected EntityDataStoreBase()
        {
        }

        /// <summary>
        /// the transaction scope used by this Entity Data Store
        /// </summary>
        ...
        {
            return shouldLock ? TransactionScope.NHibernateSession.Get<T>(id, LockMode.Upgrade) : FindByKey(id);
        }
        ...
        {
            return TransactionScope.NHibernateSession.Get<T>(id);
        }
        ...
        {
            TransactionScope.NHibernateSession.Delete(entity);
        }
        ...
        {
            TransactionScope.NHibernateSession.Save(obj);
        }
        ...
        {
            TransactionScope.NHibernateSession.Update(obj);
        }
        ...
        {
            TransactionScope.NHibernateSession.SaveOrUpdate(obj);
        }
        ...
        {
            return (T)TransactionScope.NHibernateSession.SaveOrUpdateCopy(obj);
        }
